      ...
      <div class="container ">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a data-toggle="modal" data-target="#adminProfile" class="btn"><i class="glyphicon glyphicon-user"></i> Edit Account</a></li>
            ...
            <li><a data-toggle="modal" data-target="#viewSale" class="btn"><i class="glyphicon glyphicon-calendar"></i> VIEW SALES</a></li>
            <li><a data-toggle="modal" data-target="#viewAnalysis" class="btn"><i class="glyphicon glyphicon-scale"></i> VIEW SALE ANALYSIS</a></li>
